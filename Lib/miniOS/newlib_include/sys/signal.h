...
typedef unsigned int/*long*/ sigset_t;
...
#if defined(__CYGWIN__) || defined(__rtos__)
#undef sigaddset
#undef sigdelset
#undef sigemptyset
#undef sigfillset
...
#endif /* defined(__CYGWIN__) || defined(__rtos__) */
