...
/* Register Fork Handlers, P1003.1c/Draft 10, P1003.1c/Draft 10, p. 27
    ...
    NOTE: RTOS does not provide pthread_atfork().  */
...
int _EXFUN(pthread_delay, (int ticks));
int _EXFUN(pthread_suspend, (pthread_t thread));
int _EXFUN(pthread_resume, (pthread_t thread));
unsigned long long _EXFUN(sys_timestamp, ());
#ifdef __cplusplus
}
#endif
