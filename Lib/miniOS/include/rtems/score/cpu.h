 ...
 *
 * @brief TMS320C6678 Department Source
 *
 * This include file contains information pertaining to the TMS320C6678
 * processor.
 */
 ...
 *
 *  + Anywhere there is an TMS320C6678, it should be replaced
 ...
 *
 * TMS320C6678 document implementation including references if appropriate
 */
 ...
 * the answer is TRUE.
 *
 * The macro name "TMS320C6678_HAS_FPU" should be made CPU specific.
...
/* TMS320C6678: if needed, put more variables here */
...
#define _CPU_ISR_Disable( _isr_cookie ) \
  do { \
    (_isr_cookie) = c6x_global_interrupts_get(); \
...
#define _CPU_ISR_Enable( _isr_cookie )  \
	c6x_global_interrupts_restore( _isr_cookie )
...
#define _CPU_ISR_Flash( _isr_cookie ) \
  c6x_global_interrupts_flash( _isr_cookie )
...
#define _CPU_ISR_Set_level( new_level ) \
  do { \
    if ( new_level == 0 ) c6x_global_interrupts_enable(); \
    else                   c6x_global_interrupts_disable(); \
  } while (0)
 ...
 * TMS320C6678 document implementation including references if appropriate
 */
#define   _CPU_ISR_Get_level() (c6x_global_interrupts_get() ? 0 : 1)
 ...
 * TMS320C6678 document implementation including references if appropriate
 */
#define _CPU_Fatal_halt( _source, _error ) for (;;)
 ...
 */
//extern struct Per_CPU_Control *_CPU_Per_CPU_current[];
/**
 ...
 */
//#define _CPU_Get_current_per_CPU_control() ( _CPU_Per_CPU_current[0] )
#ifdef RTEMS_SMP
/**
